...
int main(int argc, char **argv)
{
    ...
    cout << "*********************************setting up for ORB_SLAM3*********************************" << endl;
    if(argc != 3)
    {
...
void ImageGrabber::GrabImage(const sensor_msgs::ImageConstPtr& msg)
{
    ...
    transformStamped.child_frame_id = "rmtt_camera";
    transformStamped.transform.translation.x = -t_vec(2);
    transformStamped.transform.translation.y = t_vec(0);
    transformStamped.transform.translation.z = t_vec(1);
